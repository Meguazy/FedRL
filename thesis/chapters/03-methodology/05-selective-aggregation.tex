...
\node[font=\scriptsize] at (0, -1.8) {E1 (Early Only)};
\node[font=\scriptsize] at (0, -2.4) {E2 (+ Middle)};
\node[font=\scriptsize] at (0, -3.0) {E3 (+ Late)};
\node[font=\scriptsize] at (0, -3.6) {E4 (Backbone)};
...
% E2: + Middle
\node[draw, fill=red!30, minimum size=0.4cm] at (1.5, -2.4) {\tiny $\checkmark$};
\node[draw, fill=red!30, minimum size=0.4cm] at (2.8, -2.4) {\tiny $\checkmark$};
...
% E3: + Late
\node[draw, fill=red!30, minimum size=0.4cm] at (1.5, -3.0) {\tiny $\checkmark$};
\node[draw, fill=red!30, minimum size=0.4cm] at (2.8, -3.0) {\tiny $\checkmark$};
\node[draw, fill=red!30, minimum size=0.4cm] at (4.1, -3.0) {\tiny $\checkmark$};
...
\node[draw, fill=red!30, minimum size=0.4cm] at (6.7, -3.6) {\tiny $\checkmark$};
\node[draw, fill=red!30, minimum size=0.4cm] at (8, -3.6) {\tiny $\checkmark$};
