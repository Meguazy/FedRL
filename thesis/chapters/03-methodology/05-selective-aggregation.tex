...
% E2: + Middle
\node[draw, fill=red!20, minimum size=0.4cm] at (1.5, -2.4) {\tiny $\times$};
\node[draw, fill=red!20, minimum size=0.4cm] at (2.8, -2.4) {\tiny $\times$};
...
% E3: + Late
\node[draw, fill=red!20, minimum size=0.4cm] at (1.5, -3.0) {\tiny $\times$};
\node[draw, fill=red!20, minimum size=0.4cm] at (2.8, -3.0) {\tiny $\times$};
\node[draw, fill=red!20, minimum size=0.4cm] at (4.1, -3.0) {\tiny $\times$};
...
\node[draw, fill=red!20, minimum size=0.4cm] at (6.7, -3.6) {\tiny $\times$};
\node[draw, fill=red!20, minimum size=0.4cm] at (8, -3.6) {\tiny $\times$};
