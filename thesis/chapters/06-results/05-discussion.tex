...
% Performance ranking: B2 > E2 > E1 > E3 > B1 > E4
% Diversity ranking: E4 > E2 > E1 > B2 ≈ B1 ≈ E3
% Optimal balance: E2 achieves 98.9% of B2's performance with strong separation (1.51)
% Overspecialization: E4 maximizes diversity (1.95) but sacrifices 18.5% performance
% Reference: RESULTS.md Section 5.1

\subsection{Critical Role of Policy Heads}

% E3's complete failure proves policy heads encode strategic "personality"
...
% E4 analysis: worst performance despite highest separation
...
% Evidence: E4 shows lowest legal moves (686.3) - constrained positions
...
% E2's success suggests hierarchical knowledge transfer:
...
% Optimal sharing percentage: ~30-35% (E2), not 85%+ (E4)
...
%   - E1: 43% (not 23%)
%   - E2: 52% (not 32%)
%   - E4: 100% backbone (not 86%)
% Would strengthen E2 optimality conclusion
...
% E4 might benefit from adaptive learning rate scheduling
