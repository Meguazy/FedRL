...
Cross-experiment comparison aggregates final-round metrics from all six experiments (B1, B2, E1-E4) into comparison tables and visualizations. This enables identification of the optimal configuration and validation of hypotheses H1, H2, and H3.
