...
% PDF/A compliance (must be loaded first)
...
% Hyperref setup (pdfx loads hyperref automatically)
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    citecolor=blue,
    urlcolor=blue,
    pdfauthor={Francesco Finucci},
    pdftitle={Clustered Federated Learning for Chess AI},
    pdfsubject={Master's Thesis},
    pdfkeywords={federated learning, reinforcement learning, chess, AlphaZero}
}
...
\setlength{\hoffset}{26 pt}%
  \begin{center}
    ...
    \vspace{5 em}
    \vspace{-.75cm}
    \begin{tabular}[H]{p{130pt}p{120pt}p{220pt}}
      \normalsize{\textit{\textbf{Student}}} &&  \normalsize{\textit{\textbf{Supervisor}}\vspace{0.3em}}  \\
      {Francesco Finucci}  && \normalsize{Prof. Massimo Callisto De Donato\vspace{0.3em}}\\
